...
<header>
    ...
    <%-- 顶部左侧导航--%>
    <ul class="left-ul">
        <li><a href="${pageContext.request.contextPath}/listBooks">首页</a></li>
        <c:forEach items="${cl}" var="c">
            <li><a href="${pageContext.request.contextPath}/listBookByClass?classId=${c.id}">${c.classname}</a></li>
        </c:forEach>
<%--        <li><a href="#">文学</a></li>--%>
<%--        <li><a href="#">流行</a></li>--%>
<%--        <li><a href="#">文化</a></li>--%>
...
<%--        <li><a href="#">科技</a></li>--%>
        ...
        <c:if test="${sessionScope.user!=null}">
            ...
            <ul class="right-ul">
                ...
                <li><a href="${pageContext.request.contextPath}/getOneUser">个人主页</a></li>
                <li><a href="#">我的订单</a></li>
                <li><a href="#">我的钱包</a></li>
                <li><a href="#">账号管理</a></li>
